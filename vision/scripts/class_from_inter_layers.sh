...
do
    ...
    python -m CLAPPVision.vision.downstream_classification --model_path $savepath --model_num $n_epochs --encoder_type 'vgg_like' --model_splits 6 --train_module 6 --module_num $i --in_channels ${n_in_channels[$i-1]}
